...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, enemy_type, screen_size, fps, floor_height):
        ...
        self.image_death = [pygame.image.load('sprites/enemies/death.png'),
                            pygame.image.load('sprites/enemies/death_1.png'),
                            pygame.image.load('sprites/enemies/death_2.png'),
                            pygame.image.load('sprites/enemies/death_3.png'),
                            pygame.image.load('sprites/enemies/death_4.png')]
        self.speed = 2
